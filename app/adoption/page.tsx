...
export const metadata: Metadata = {
    title: "Adoption Compatibility Page | MPLP",
    description: "Legacy adoption route retained for compatibility. The current website discovery route for evaluation context is /references.",
    alternates: {
...
export default function AdoptionPage() {
    const compatibilitySchema = {
        ...
        "@type": "WebPage",
        "name": "Adoption Compatibility Page",
        ...
        <Shell>
            ...
            <div className="pt-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <Breadcrumb items={[
                    ...
                    { label: "Adoption Compatibility", href: "/adoption" }
                ]} />
            </div>
            <PageHeader
                title="Adoption Compatibility Page"
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="rounded-2xl border border-mplp-border bg-slate-950/50 p-8 text-center">
                        <p className="text-lg text-mplp-text-muted leading-relaxed">
                            This route no longer serves as the current public evaluation or adoption page.
                            Use <strong className="text-mplp-text">/references</strong> for current website discovery context.
                        </p>
