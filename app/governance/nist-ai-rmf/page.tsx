    ...
    return (
        <Shell>
            ...
            <PageHeader
                ...
                subtitle="Discovery-only reference page for NIST AI RMF context around MPLP. Detailed mapping material, where published, lives in Documentation and related authority surfaces."
            ...
            <ContentSection background="surface">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <Button href={DOCS_URLS.standardsNistMapping} variant="primary" size="lg" external>
                            Open Docs Mapping ↗
                        </Button>
