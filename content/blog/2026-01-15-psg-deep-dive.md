...
2. **状态独立追踪**：每个 Step 有自己的状态（示意：`pending -> in_progress -> completed/failed`，具体枚举以 [Plan Schema](https://github.com/Coregentis/MPLP-Protocol/blob/main/schemas/v2/mplp-plan.schema.json) 为准）
...
3. [GraphUpdateEvent Schema](https://github.com/Coregentis/MPLP-Protocol/blob/main/schemas/v2/events/mplp-graph-update-event.schema.json)
4. [MPLP Repository](https://github.com/Coregentis/MPLP-Protocol)
